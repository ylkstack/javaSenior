...
public class Java10Test {
    ...
    public void test1() {
        ...
        //带泛型的使用类型推断时，在对象区指明使用的泛型
        var list = new ArrayList<Integer>();
        list.add(123);
        //2.遍历操作
        //因为list决定了他本身是什么类型。所以可以使用类型推断
        for (var i : list) {
    ...
    public void test2() {
        //1.局部变量不赋值，就不能实现类型推断
        var num = "hello";
        //2.Lanbda表达式中，左边的函数式接口不能声明为var
//        Supplier<Double> sup = () -> Math.random();
//        var sup = () -> Math.random();

        //3.方法引用中,左边的函数式接口不能声明为var
//        Consumer<String> con = System.out::println;
        //因为如果使用类型推断Consumer 抽象接口都没了，无法推断
//        var con = System.out::println;

        //4.数组的静态初始化中，注意如下情况也不可以
//        int[] arr = new int[]{1, 2, 3, 4};
//        var arr = new int[]{1, 2, 3, 4};//此种可以
//        var arr = {1, 2, 3, 4};//此种不可以
    }
...
//    int num = 10;
    ...
    public void test5() {
        ...
        //结论：copyOf(Xxx coll):如果参数cloo本身就是一个只读集合，则copyOf()返回值即为当前coll
